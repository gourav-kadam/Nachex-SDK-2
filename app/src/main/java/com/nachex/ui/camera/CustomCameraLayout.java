...
public class CustomCameraLayout extends FrameLayout {
    ...
    public CustomCameraLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttrs(attrs);
    }

    public CustomCameraLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (r < b) {
            System.out.println("onLayoutonLayout=IF");
            ...
            System.out.println("onLayoutonLayout=ELSE");
            //int contentWidth = height * 4 / 3;
            int contentWidth = height * 5 / 3;
