...
public class FrameOverlayView extends View {
    ...
    private void resetFrameRect(int w, int h) {
        ...
        /*frameRect.left = (int) (w * 0.05);//crop
        frameRect.top = (int) (h * 2);*/
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float ex = 60;
        RectF rectExtend = new RectF(frameRect.left - ex, frameRect.top - ex, frameRect.right + ex, frameRect.bottom + ex);
        if (!result) {
