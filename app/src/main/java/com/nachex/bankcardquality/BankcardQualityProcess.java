package com.nachex.bankcardquality;
...
public class BankcardQualityProcess {
    final ReentrantReadWriteLock nativeModelLock = new ReentrantReadWriteLock();
    private static BankcardQualityProcess mInstance;
    ...
    public BankcardQualityProcess() {
    }

    public static synchronized BankcardQualityProcess getInstance() {
        if (null == mInstance) {
            mInstance = new BankcardQualityProcess();
        }
